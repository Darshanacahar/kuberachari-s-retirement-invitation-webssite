...
function Index() {
  ...
  const timeline = [
    ...
    },
    {
      year: "ಸಂಘಟನಾ ಸೇವೆ",
      title: "ಸಂಘಟನಾ ಚತುರ",
      desc: "ಕರ್ನಾಟಕ ರಾಜ್ಯ ಪ್ರಾಥಮಿಕ ಶಾಲಾ ಶಿಕ್ಷಕರ ಸಂಘದ ಹೊಸಪೇಟೆ ಘಟಕದ ಅಧ್ಯಕ್ಷರಾಗಿ ಹಾಗೂ ವಿಜಯನಗರ ಜಿಲ್ಲಾ ಘಟಕದ ಉಪಾಧ್ಯಕ್ಷರಾಗಿ, ಕರ್ನಾಟಕ ರಾಜ್ಯ ಸರ್ಕಾರಿ ನೌಕರರ ಸಂಘದ ಪ್ರತಿನಿಧಿಯಾಗಿ 15 ವರ್ಷ ಸೇವೆ ಸಲ್ಲಿಸಿ, ಒಟ್ಟಾರೆ ಸುಮಾರು 25 ವರ್ಷಗಳ ಕಾಲ ಶಿಕ್ಷಕರ ಸಂಘದಲ್ಲಿ ನಿಸ್ವಾರ್ಥ ಸೇವೆ ಸಲ್ಲಿಸಿದ್ದಾರೆ.",
    },
    {
      year: "30 ವರ್ಷಗಳು",
      title: "ಸುಧೀರ್ಘ ಸೇವೆ",
